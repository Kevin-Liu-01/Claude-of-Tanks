...
const garage: MainGarageRuntime = await bootStage('ui', () => createGarage({
  ...
  camo: {
    ...
    label: {
      ...
      sig_ares_apc_x: t('camoPattern.sig_ares_apc_x'),
      ...
      sig_type100: t('camoPattern.sig_type100'),
      sig_ztz100_x: t('camoPattern.sig_ztz100_x'),
      sig_object695_x: t('camoPattern.sig_object695_x'),
      ...
      sig_merkava2d: t('camoPattern.sig_merkava2d'),
      sig_merkava3d_x: t('camoPattern.sig_merkava3d_x'),
      sig_merkava4: t('camoPattern.sig_merkava4'),
