...
the fixed battle step; `battleWarmRuntime.ts` owns battle-only terrain, wreck,
and common-FX residency behind a retryable typed access facade; `ai.js` owns bot decisions and is
