...
export const GARAGE_PRESENTATION_POSE = Object.freeze({
  // Vehicle forward is local +Z. The camera stays on that bow hemisphere
  // and sits to world +X so the bow and gun point toward screen-right in the
  // original Verdant composition.
  heroHeadingRad: 0,
