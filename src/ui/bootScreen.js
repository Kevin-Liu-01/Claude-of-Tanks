...
const TIPS = [
  ...
  ['Free look', 'Hold Left Alt by default to look around without turning the turret or moving the gun. Release it to snap back to your aim; rebind it under Controls.'],
