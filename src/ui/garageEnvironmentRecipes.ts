...
export interface GarageStructurePlacement {
  ...
  /** Signed screen-space offset around the canonical front three-quarter view. */
  readonly side: number;
  /** Distance behind the hero along the canonical camera axis. */
...
const at = (builder: StructureBuilder, label: string, side: number, depth: number,
  yaw = 0, scale = 1): GarageStructurePlacement => ({ builder, label, side, depth, yaw, scale });
...
export const GARAGE_ENVIRONMENT_RECIPES = Object.freeze<Record<string, GarageEnvironmentRecipe>>({
  field_shed: {
    ...
    structures: [
      at(makeFarmhouse, 'field farmhouse', 16, 30, 0.16, 0.88),
      at(makeTavern, 'village tavern', -16, 30, -0.16, 0.76),
      at(makeShed, 'maintenance shed', 9, 39, 0.28, 0.82),
      at(makeGranary, 'hedgerow granary', -9, 39, 0.18, 0.68),
      at(makeWoodshed, 'field stores', 0, 45, -0.10, 0.70),
    ],
  ...
  shade_depot: {
    ...
    structures: [
      at(makeCaravanserai, 'wadi caravanserai', 16, 30, 0.12, 0.84),
      at(makeMinaret, 'wadi minaret', -16, 30, 0.08, 0.76),
      at(makeShed, 'forward shade bay', 9, 39, -0.24, 0.82),
      at(makeDepot, 'wadi supply depot', -9, 39, -0.10, 0.68),
      at(makeCaravanserai, 'outer adobe court', 0, 45, 0.20, 0.56),
    ],
    treeSpecies: ['palm', 'acacia'], treeCount: 18,
  ...
  repair_bunker: {
    ...
    structures: [
      at(makeRangerLodge, 'winter ranger lodge', 16, 30, 0.14, 0.82),
      at(makeAlpine, 'snow service chalet', -16, 30, -0.16, 0.78),
      at(makeChapel, 'frost chapel', 9, 39, 0.10, 0.72),
      at(makeLogCabin, 'snowline cabin', -9, 39, 0.20, 0.66),
      at(makeWoodshed, 'winter stores', 0, 45, -0.12, 0.68),
    ],
  ...
  brick_arsenal: {
    ...
    structures: [
      at(makeFactory, 'urban factory', 16, 30, 0.12, 0.76),
      at(makeFireStation, 'Steinburg fire station', -16, 30, -0.14, 0.78),
      at(makeCornerShop, 'arsenal corner shop', 9, 39, 0.18, 0.74),
      at(makeChurch, 'old-city church', -9, 39, 0.08, 0.54),
      at(makeFactory, 'arsenal annex', 0, 45, -0.08, 0.56),
    ],
  ...
  naval_drydock: {
    ...
    structures: [
      at(makeFishery, 'working fishery', 16, 30, 0.14, 0.78),
      at(makeLighthouse, 'harbor lighthouse', -16, 30, 0, 0.84),
      at(makeBoatshed, 'harbor boatshed', 9, 39, -0.14, 0.72),
      at(makeShed, 'drydock service bay', -9, 39, 0.24, 0.78),
      at(makeBoatshed, 'breakwater boatshed', 0, 45, 0.18, 0.62),
    ],
  ...
  rail_roundhouse: {
    ...
    structures: [
      at(makeWarehouse, 'freight warehouse', 16, 30, 0.12, 0.78),
      at(makeGantry, 'rail gantry', -16, 30, -0.16, 0.82),
      at(makeContainerRow, 'container rank', 9, 39, 0.12, 0.74),
      at(makeWaterTower, 'junction water tower', -9, 39, 0, 0.72),
      at(makeWarehouse, 'roundhouse annex', 0, 45, 0.18, 0.58),
    ],
  ...
  rain_canopy: {
    ...
    structures: [
      at(makeBathhouse, 'monsoon bathhouse', 16, 30, 0.12, 0.8),
      at(makeDepot, 'ridge field depot', -16, 30, -0.14, 0.8),
      at(makeFishery, 'ridge longhouse workshop', 9, 39, -0.12, 0.62),
      at(makeShed, 'rain service canopy', -9, 39, 0.24, 0.76),
      at(makeLogCabin, 'ridge crew lodge', 0, 45, 0.16, 0.64),
    ],
    treeSpecies: ['eucalyptus', 'palm'], treeCount: 28, reliefScale: 0.72,
  ...
  rock_cavern: {
    ...
    structures: [
      at(makeRangerLodge, 'glacier lodge', 16, 30, 0.12, 0.8),
      at(makeAlpine, 'pass chalet', -16, 30, -0.14, 0.78),
      at(makeChapel, 'ridge chapel', 9, 39, 0.10, 0.72),
      at(makeShed, 'pass service shelter', -9, 39, -0.20, 0.72),
      at(makeLogCabin, 'glacier outpost', 0, 45, 0.18, 0.62),
    ],
    treeSpecies: ['spruce', 'fir'], treeCount: 26, reliefScale: 0.38,
  ...
  recovery_yard: {
    ...
    structures: [
      at(makeCaravanserai, 'redrock compound', 16, 30, 0.12, 0.74),
      at(makeWarehouse, 'recovery warehouse', -16, 30, -0.14, 0.74),
      at(makeGantry, 'heavy lift gantry', 9, 39, 0.18, 0.76),
      at(makeWaterTower, 'divide water tower', -9, 39, 0, 0.68),
      at(makeContainerRow, 'salvage container line', 0, 45, 0.16, 0.62),
    ],
  ...
  factory_line: {
    ...
    structures: [
      at(makeFoundryOffice, 'foundry office', 16, 30, 0.12, 0.8),
      at(makeFactory, 'heavy factory', -16, 30, -0.14, 0.76),
      at(makeStack, 'smokestack', 9, 39, 0, 0.82),
      at(makeWaterTower, 'works water tower', -9, 39, 0, 0.70),
      at(makeWarehouse, 'works warehouse', 0, 45, 0.14, 0.58),
    ],
