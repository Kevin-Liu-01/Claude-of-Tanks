...
export const TRACK_PATTERN_DEFINITIONS = Object.freeze({
  'interleaved-cleat': Object.freeze({
    ...
    surface: 'triple-bar', padCoverage: 0.94, padHeight: 0.040,
    grouserHeight: 0.014, shoulderHeight: 0.008,
    webHeight: 0.022, webDepth: 0.64, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
    shadePalette: Object.freeze([0x2a2c2b, 0x323533, 0x3a3c39]),
  }),
  'early-cast-steel': Object.freeze({
    label: 'cast-steel block shoe',
    surface: 'cast-block', padCoverage: 0.93, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.003,
    webHeight: 0.022, webDepth: 0.66, hornHeight: 0.085,
    pinStyle: 'end-caps', pinRadius: 0.022,
    shadePalette: Object.freeze([0x30312f, 0x383936, 0x282a29]),
  }),
  'soviet-single-pin': Object.freeze({
    label: 'single-pin chevron shoe',
    surface: 'chevron', padCoverage: 0.92, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.003,
    webHeight: 0.022, webDepth: 0.62, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.016,
    shadePalette: Object.freeze([0x292b2a, 0x323432, 0x3b3d3a]),
  }),
  'nato-double-pin': Object.freeze({
    label: 'paired-pad double-pin shoe',
    surface: 'paired-pad', padCoverage: 0.92, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.003,
    webHeight: 0.022, webDepth: 0.64, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
  ...
  'merkava-heavy': Object.freeze({
    ...
    surface: 'heavy-chevron', padCoverage: 0.95, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.003,
    webHeight: 0.022, webDepth: 0.68, hornHeight: 0.085,
    pinStyle: 'end-caps', pinRadius: 0.019, // 19 mm pins: the Merkava X return rollers ride their authored seats under the 28 mm band (2026-09-17)
    shadePalette: Object.freeze([0x282a29, 0x303331, 0x393b38]),
  }),
  'compact-ifv': Object.freeze({
    label: 'fine-pitch IFV shoe',
    surface: 'fine-rib', padCoverage: 0.91, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.006,
    webHeight: 0.022, webDepth: 0.60, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.016,
    shadePalette: Object.freeze([0x2e302f, 0x373a38, 0x3e413e]),
  }),
  'eastern-ifv': Object.freeze({
    label: 'open-chevron IFV shoe',
    surface: 'open-chevron', padCoverage: 0.92, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.004,
    webHeight: 0.022, webDepth: 0.62, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.016,
  ...
  'british-rubber-pad': Object.freeze({
    ...
    surface: 'rubber-block', padCoverage: 0.93, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.004,
    webHeight: 0.022, webDepth: 0.66, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
  ...
  'franco-italian-modular': Object.freeze({
    ...
    surface: 'split-chevron', padCoverage: 0.92, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.004,
    webHeight: 0.022, webDepth: 0.64, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
  ...
  'japanese-modular': Object.freeze({
    ...
    surface: 'staggered-rib', padCoverage: 0.92, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.004,
    webHeight: 0.022, webDepth: 0.63, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
  ...
  'hydropneumatic-dead-track': Object.freeze({
    ...
    surface: 'dead-track', padCoverage: 0.94, padHeight: 0.034,
    grouserHeight: 0.014, shoulderHeight: 0.003,
    webHeight: 0.022, webDepth: 0.70, hornHeight: 0.070,
    pinStyle: 'end-caps', pinRadius: 0.022,
    shadePalette: Object.freeze([0x292b2a, 0x313432, 0x393c39]),
  }),
  'siege-wide': Object.freeze({
    label: 'wide siege traction shoe',
    surface: 'heavy-chevron', padCoverage: 0.96, padHeight: 0.040,
    grouserHeight: 0.014, shoulderHeight: 0.009,
    webHeight: 0.022, webDepth: 0.72, hornHeight: 0.085,
    pinStyle: 'end-caps', pinRadius: 0.022,
