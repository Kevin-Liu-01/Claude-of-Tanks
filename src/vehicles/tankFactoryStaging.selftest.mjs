...
const goldenReceipts = [
  ...
  },
  {
    ...
    "_repin_2026_09_25_fsp06": "FSP-06 material roles (owner 2026-09-25): merkava1b's pale-kit soft goods ride the new canvasPale material and its jerry cans the fitting paint (merkava.ts, materials.ts) — the material-inclusive digest moves; geometry and order unchanged (tank:anatomy:check, presentation-centering --check green); repinned from the current build",
