...
const CHINESE_FRONTLINE_SPECS = {
  ...
  ztz100_prototype: {
    ...
    gun: {
      caliberMm: 35, reloadS: 8.2, baseAccuracy: 0.30, aimTimeS: 1.7,
      ...
      shells: [
        shell('HJ-P9 Tandem', 'HEAT', 152, 950, 950, 650, 320,
          { pen2000Mm: 950, reloadS: 8.2, count: 12, guided: true, soundProfile: 'konkurs-launch', launcherTubes: 8 }),
        shell('HJ-P9 Blast', 'HE', 152, 65, 65, 800, 320,
          { reloadS: 9, count: 8, guided: true, soundProfile: 'konkurs-launch', launcherTubes: 8 }),
