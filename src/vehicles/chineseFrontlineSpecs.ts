...
const CHINESE_FRONTLINE_SPECS = {
  ...
  type100: {
    ...
    dims: { hullLengthM: 7.30, overallLengthM: 9.40, widthM: 3.66, heightM: 2.42, silhouetteHeightM: 3.55 },
    armor: modernArmor({
      hl: 3.65, hw: 1.70, inW: 1.15, floor: 0.38, trkTop: 1.24, roofY: 1.80,
      turretPivot: [0, 1.80, -0.40], gunPivot: [0, 0.34, 1.10],
      barrelLenM: 4.95, barrelRadM: 0.078,
      glacis: [90, 520, 720], lower: [70, 340, 460], side: [55, 240, 360],
      skirt: [35, 110, 240], rear: 40, roof: 38,
      tw: 1.32, tFrontZ: 1.72, tRearZ: -1.88, tH: 0.62,
