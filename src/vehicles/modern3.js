...
function buildK1A1(P) {
  ...
  P.add('turret', box(0.48, 0.07, 0.54), 0.55, 0.565, 0.42);                   // doghouse buried seat / explicit roof load path
  P.add('turret', box(0.42, 0.10, 0.50), 0.55, 0.63, 0.42);                    // doghouse right, sunk into the new crown
