...
export const INTERIOR_FILLS: Readonly<Record<string, InteriorFillRecord>> = Object.freeze({
  "ares_apc_x": { v: 0.025, o: [-2.03, 0.0504, -3.681], t: [-0.3835, 2.2502, 0.5027], g: [-0.4265, 3.078, 0.397], hull: "XgBcAI0AdQBdAKAAXABcAJAAXQBdAKcAdgBcAJAAdwBdAKcAWgBcAJIAWwBdAKUAeABcAJIAeQBdAKUAXgBcAKEAbQBdAKoAbgBcAKQAdQBdAKoA" },
});
