...
export const VEHICLE_MARKING_ANCHORS: Readonly<Record<string, VehicleMarkingAnchor>> = Object.freeze({
  griffin_viper: anchor('hull', 'left', .52, .58, .20, 1),
  ...
  griffin50_x: anchor('hull', 'left', .52, .58, .20, 1),
  ajax_x: anchor('hull', 'left', .52, .58, .20, 1),
  aft10_x: anchor('hull', 'left', .52, .58, .20, 1),
  bmp3m_dragun125_x: anchor('hull', 'left', .52, .58, .20, 1),
  k21_x: anchor('hull', 'left', .52, .58, .20, 1),
  ...
  cv90_x: anchor('hull', 'left', .52, .58, .20, 1),
  type89_x: anchor('hull', 'left', .38, .60, .24, 1),
  cv90_mkiv_x: anchor('hull', 'left', .52, .58, .20, 1),
  cv90105_tml_x: anchor('hull', 'left', .52, .58, .20, 1),
  sabra_mk2_x: anchor('hull', 'left', .52, .58, .20, 1),
  kurganets25_x: anchor('hull', 'left', .58, .57, .22, 1),
  ...
  k2: anchor('turret', 'left', .35, .45, .24, 1),
