...
const BASE_CAMO_PATTERN_IDS = Object.freeze([
  ...
  'sig_merkava4b',
  'sig_merkava2d', 'sig_merkava3d_x', 'sig_merkava4_x', 'sig_merkava4_trophy', 'sig_merkava4_barak', 'sig_namer_ifv',
...
const BASE_CAMO_PATTERN_LABEL: Readonly<Record<typeof BASE_CAMO_PATTERN_IDS[number], string>> = Object.freeze({
  ...
  // Signature/service labels follow the SOURCE hull's public name (owner roster pass 2026-09-15):
  // the old 2A4M is the 2A4M CAN, the old 2A6M the 2A4 OTCO, the old 2A4 OTCO the 2A3, the KF51B
  // the KF51-U, the old T-90M the T-90AM, the old K2 the XK2, the ua_m1a1 the M1A1 SA (Ukraine).
  service_leo2a4m: 'Leopard 2A4M CAN Service',
  service_leo2a6m: 'Leopard 2A4 OTCO Service',
...
export const SIGNATURE_CAMO_TANK_IDS = Object.freeze([
  ...
  'merkava2d', 'merkava3d_x', 'merkava4_x', 'merkava4_trophy', 'merkava4_barak', 'namer_ifv',
  'sabra_mk2_x',
