...
// ---------------------------------------------------------------------------
// Revolution Prototype retains its authored chassis and running gear. The
// owner-directed 2026-09-23 turret is an earlier interpretation of the current
...
function buildLeo2RevolutionPrototype(P: TankBuilderPort) {
  ...
  buildLeopardRevolutionPrototypeTurret(P);

  // Retain the authored hull finish, rear lattice, cables and deck panels.
  // Turret finish and equipment belong entirely to the new turret builder.
  const buildLeo2RevolutionRunningGearStage1 = (): void => {
    {
      ...
      // Preserve the original hull deck finish.
      {
...
export const LEOPARD_PROFILES = {
  ...
  leo2_revolution_proto: { build: buildLeo2RevolutionPrototype },
