...
const T72B3_X_DATUMS=T72B3_X_SOURCE_DATUMS;
...
function runningGear(P:TankBuilderPort):void {
  ...
  P.gear=KIT.buildRunningGear(P,{style:'rubber',wheelR:.3568,wheelY:.395,
    wheelW:.453,wheelZs:[-1.70205,-.91970,-.12865,.67990,1.47690,2.28460],
    xc:1.4491,xcLeft:1.4518,xcRight:1.4464,trackW:.5564,trackTh:.030, // Russian X track standard 2026-09-12: band .030, pad .036, web .018
    ...
    trackShoeDimensions:{padHeight:.036,grouserHeight:.009,webHeight:.018,hornHeight:.052,pinRadius:.010,pinCentreY:0},
  });
}
...
function buildT72B3X(P:TankBuilderPort):void {
