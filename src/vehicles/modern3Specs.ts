    ...
    gun: {
      ...
      shells: [
        ...
        shell('BGM-71 TOW-2A', 'HEAT', 152, 900, 900, 540, 195,
          { reloadS: 2.5, count: 7, guided: true, soundProfile: 'tow-launch', launcherTubes: 2 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('9M113M Konkurs-M', 'HEAT', 135, 750, 750, 430, 162.5,
          { reloadS: 2.3, count: 5, guided: true, soundProfile: 'konkurs-launch', launcherTubes: 1 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('Spike LR', 'HEAT', 152, 760, 760, 520, 117,
          { reloadS: 2.5, count: 6, guided: true, soundProfile: 'spike-launch', launcherTubes: 2 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('Spike LR2 MELLS', 'HEAT', 152, 900, 900, 680, 180,
          { reloadS: 2.25, count: 8, guided: true, soundProfile: 'spike-launch', launcherTubes: 2 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('Type 01 Jyu-MAT Kai', 'HEAT', 160, 950, 950, 720, 210,
          { reloadS: 2.1, count: 12, guided: true, soundProfile: 'jyu-mat-launch', launcherTubes: 4 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('Spike ER2', 'HEAT', 170, 1050, 1050, 760, 240,
          { reloadS: 2.2, count: 8, guided: true, soundProfile: 'spike-launch', launcherTubes: 2 }),
    ...
    gun: {
      ...
      shells: [
        ...
        shell('Type 79 Jyu-MAT', 'HEAT', 153, 700, 700, 500, 130,
          { reloadS: 2.4, count: 6, guided: true, soundProfile: 'jyu-mat-launch', launcherTubes: 2 }),
