...
const entries = [
  ['leo2a6_x', 'leo2a6', 'Leopard 2A6'],
  ['k1a1_x', 'k1a1', 'K1A1'],
  ['amx30_x', 'amx30', 'AMX-30B'],
  ...
  ['type10_x', 'type10', 'Type 10'],
  ['type90_x', 'type90', 'Type 90'],
  ...
  ['t90_x', 't90', 'T-90'],
  ['t90a_burlak_x', 't90a_burlak', 'T-90A Burlak'],
  ['t90ms_x', 't90ms', 'T-90MS Tagil'],
] as const;
