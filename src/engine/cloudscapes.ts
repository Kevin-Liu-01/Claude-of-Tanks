...
export const CLOUDSCAPE_REGIMES: Readonly<Record<CloudscapeRegime, CloudscapeRegimeRow>> = Object.freeze({
  ...
  'towering-cumulus': row({ coverage: 0.36, baseM: 1200, thicknessM: 1800, towers: 0.7, anvil: 0.15, wispiness: 0.3, windSpeed: 5, shear: 0.25, streets: 0.2, cirrus: 0.1, cirrusAltM: 11000, stratiform: 0.05, fieldMix: 0, density: 0.10, farBand: 0.3, scud: 0, type: [0.45, 0.9], sunGain: 1, ambientScale: 1, clearRadiusM: 0, shadow: true }),
