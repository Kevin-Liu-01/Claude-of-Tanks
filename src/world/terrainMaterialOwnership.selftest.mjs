...
function checkSourceContract(text) {
  ...
  assert.match(text, /mat\.customProgramCacheKey = \(\) => 'world-terrain-splat-v32';/);
}
...
assert.throws(() => checkSourceContract(source.replace('world-terrain-splat-v32', 'world-terrain-splat-v31')));
