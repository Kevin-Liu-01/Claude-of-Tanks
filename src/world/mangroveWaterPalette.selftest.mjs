...
function verifyHistoricalConfigs(resolve) {
  ...
  assert.equal(hash(JSON.stringify(unchangedMaps)),
    ...
    '2e430e060d3b9fdd4e6e8248dcc046a4e29df413beeb8525ca7a49d8d87a218d', // 2026-09-24 (round 66): the eleven sea-sheet maps author an `ocean` block (was 2bac4c86…: round 57, steppe.ts terrain block authors railSpurs; 89a7af50…: round 55, fjord.ts horizon block authors outcrops: 1; e4c7ce4b…: Frosthollow / Amberford / Tarkhan player pads moved, round-48 pacing landing)
