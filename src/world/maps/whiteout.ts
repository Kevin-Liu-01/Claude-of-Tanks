...
export default {
  ...
  // ladder — the foothill kept low (amp 1.15: at 1.45 the first ridge, a terrain-material face, walled off the ranges)
  ...
  // on the lower slopes
  horizon: { baseHex: 0xa3b1be, amp: 1.15, style: 'alpine', relief: 'polar', treeline: 0.22, snowline: 0.30, forestHex: 0x536371, rockHex: 0x5b6772, bareRock: 0.35, haze: 0.92, grain: 0.60 },
