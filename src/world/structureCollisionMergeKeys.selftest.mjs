...
try {
  ...
  // settlement pass 3: +4 for the door lantern (bracket, cage, glass, cap).
  assert.equal(geometries.length, 103, 'the real placed onionchurch, including authored exterior and window joinery');
