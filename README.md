...
<p align="center">
  Free browser-native armored combat built with <strong>Three.js</strong>. Take 189 production-visible first-party procedural vehicles
...
| | Current runtime |
| --- | --- |
| Fleet | **189** production-visible and **226** keyed local-development procedural vehicles across **228** saved roster records; **0** GLB-sourced playables |
...
The provenance gate currently reports **199 first-party procedural battle playables and 0 GLB-sourced playables**. Comparison inputs are never a playable loading path and are stripped from public builds.
...
<td width="50%"><img src="public/media/showcase-r2/01_garage_verdant.webp" alt="Current Claude of Tanks Garage displaying a K2 in Verdant Motor Pool"><br><sub><b>One shared fleet:</b> battle, garage, Gallery, Studio, bots, icons, diagrams, and technical dossiers read the same vehicle specifications—189 in production or 226 in keyed local development.</sub></td>
</tr>
</table>
...
<tr>
<td width="50%"><img src="public/media/showcase-r2/11_gallery_hero.webp" alt="Current Tank Gallery showing a T-90M Proryv and technical dossier"><br><sub><b>Tank Gallery:</b> search 189 production vehicles or 226 with the local development fleet enabled, orbit and articulate the current vehicle rig, inspect armor, modules, and crew, and export exact-surface review packets.</sub></td>
