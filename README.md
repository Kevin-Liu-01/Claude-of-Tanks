...
| | Current runtime |
| --- | --- |
| Fleet | **127** production-visible and **164** keyed local-development procedural vehicles across **166** saved roster records; **0** GLB-sourced playables |
...
The provenance gate currently reports **137 first-party procedural battle playables, 0 GLB-sourced playables, and 7
