/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 976b97872b4b43a70a1b46e06c908c00)
// Runtime types generated with workerd@1.20260923.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	ROOM_CONNECT_LIMITER: RateLimit;
	ALLOWED_ORIGINS: string;
	MATCH_SHIM_URL: string;
	ROOMS: DurableObjectNamespace<import("./src/index").Room>;
	MATCH: DurableObjectNamespace<import("./src/index").MatchContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Room" | "MatchContainer";
	}
