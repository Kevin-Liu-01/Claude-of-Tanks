...
Base: `d6cc60fe38bfef5143075c900728603797a27e94`. This is a scoped art
candidate, not a claim of accepted visuals or measured performance parity.
...
external environment-recovery evidence directory. Only completed receipts may
be used for acceptance; source tests do not establish final rendered quality.
