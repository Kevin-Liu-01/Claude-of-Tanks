...
| --- | --- |
| Playable fleet | 128 production-visible and 165 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 138 first-party procedural battle
...
The canonical saved-roster report separately tracks all 167 records, including
