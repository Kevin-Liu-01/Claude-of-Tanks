...
| --- | --- |
| Playable fleet | 141 production-visible and 178 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 151 first-party procedural battle
...
The canonical saved-roster report separately tracks all 180 records, including
