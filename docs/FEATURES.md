...
| --- | --- |
| Playable fleet | 125 production-visible and 162 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 135 first-party procedural battle
...
The canonical saved-roster report separately tracks all 164 records, including
