...
| --- | --- |
| Playable fleet | 116 production-visible and 153 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 126 first-party procedural battle
playables, no GLB-sourced playables, and seven isolated comparison candidates.
The canonical saved-roster report separately tracks all 155 records, including
