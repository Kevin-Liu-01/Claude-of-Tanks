...
| --- | --- |
| Playable fleet | 190 production-visible and 227 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 200 first-party procedural battle
...
The canonical saved-roster report separately tracks all 229 records, including
