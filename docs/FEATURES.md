...
| --- | --- |
| Playable fleet | 170 production-visible and 207 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 180 first-party procedural battle
...
The canonical saved-roster report separately tracks all 209 records, including
