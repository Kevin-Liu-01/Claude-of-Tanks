...
| --- | --- |
| Playable fleet | 189 production-visible and 226 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 199 first-party procedural battle
...
The canonical saved-roster report separately tracks all 228 records, including
