...
| --- | --- |
| Playable fleet | 183 production-visible and 220 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 193 first-party procedural battle
...
The canonical saved-roster report separately tracks all 222 records, including
