...
| --- | --- |
| Playable fleet | 172 production-visible and 209 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 182 first-party procedural battle
...
The canonical saved-roster report separately tracks all 211 records, including
