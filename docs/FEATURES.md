...
| --- | --- |
| Playable fleet | 184 production-visible and 221 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 194 first-party procedural battle
...
The canonical saved-roster report separately tracks all 223 records, including
