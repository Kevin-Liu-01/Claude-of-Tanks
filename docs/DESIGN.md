...
| tools/tmp-tank-critic.mjs + tmp-tank-critic.html | The official 14 shaded ref/proc pairs (front..close-roof) at camoSeed 4242 → shots/critic-<id>/; the critic's raw evidence; graduates measure via its CRITIC_REFERENCE_OVERRIDES map |
