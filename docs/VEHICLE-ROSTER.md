...
Claude of Tanks currently retains **227 saved vehicle records**: **188 production-visible**, **37 local development models**, and **2 non-playable reference placeholders**. Production carousels, matchmaking, the Tank Gallery, and Scene Studio use the production projection.
...
| 42 | PROD | `cv90_mkiv` | CV90 Mk IV | Sweden | X | Next Generation | Production |
| 43 | PROD | `cv90_mkiv_x` | CV90 Mk IV X | Sweden | X | Next Generation | Production |
...
| 172 | PROD | `k2b` | K2B | South Korea | X | Modern | Production |
...
| 181 | PROD | `kurganets25_x` | Kurganets-25 | Russia | IX | Next Generation | Production |
| 182 | PROD | `upior` | Upiór IFV | Poland | IX | Next Generation | Production |
| 183 | PROD | `bmpt_t90` | BMPT T-90 | Russia | X | Modern | Production |
| 184 | PROD | `m551_sheridan` | M551 Sheridan | USA | IX | Cold War | Production |
| 185 | PROD | `m551a1_tts` | M551A1 TTS | USA | X | Next Generation | Production |
| 186 | PROD | `leo2a7v_x` | Leopard 2A7V | Germany | X | Modern | Production |
| 187 | PROD | `leo2a6m_x` | Leopard 2A6M | Germany | X | Modern | Production |
| 188 | PROD | `leo2a4m_x` | Leopard 2A5M | Germany | X | Modern | Production |
| 189 | PROD | `leo2a5_x` | Leopard 2A5 | Germany | X | Modern | Production |
| 190 | PROD | `k2_x` | K2 Black Panther | South Korea | IX | Modern | Production |
| 191 | PROD | `kf51_x` | KF51 Panther | Germany | X | Next Generation | Production |
| 192 | PROD | `t90a_x` | T-90A | Russia | X | Modern | Production |
| 193 | PROD | `t90a_vladimir_x` | T-90A Vladimir | Russia | X | Modern | Production |
| 194 | PROD | `t90m_x` | T-90M | Russia | X | Modern | Production |
| 195 | PROD | `t90sm_x` | T-90SM | Russia | X | Modern | Production |
| 196 | PROD | `t14_x` | T-14 Armata | Russia | X | Next Generation | Production |
| 197 | PROD | `griffin50_x` | Griffin 50 mm X | USA | X | Next Generation | Production |
| 198 | PROD | `kf41_lynx_x` | KF41 Lynx Prototype X | Germany | X | Next Generation | Production |
| 199 | PROD | `k21_x` | K21 X | South Korea | IX | Modern | Production |
| 200 | PROD | `leo2a6_x` | Leopard 2A6 | Germany | X | Modern | Production |
| 201 | PROD | `k1a1_x` | K1A1 | South Korea | VIII | Modern | Production |
| 202 | PROD | `amx30_x` | AMX-30B | France | VII | Cold War | Production |
| 203 | PROD | `t62mv1_x` | T-62MV-1 | USSR/Russia | VII | Cold War | Production |
| 204 | PROD | `t72b_1987_x` | T-72B obr. 1987 | USSR/Russia | VIII | Modern | Production |
| 205 | PROD | `t80u_x` | T-80U | USSR/Russia | VIII | Modern | Production |
| 206 | PROD | `leclerc_x` | Leclerc XLR | France | X | Modern | Production |
| 207 | PROD | `leclerc_classic_x` | AMX 56 | France | X | Modern | Production |
| 208 | PROD | `chieftain_mk10_x` | Chieftain Mk 10 | UK | VIII | Modern | Production |
| 209 | PROD | `t72b3_x` | T-72B3 | Russia | VIII | Modern | Production |
| 210 | PROD | `jpz_e100_x` | Jagdpanzer E100 | Germany | VII | World War II | Production |
| 211 | PROD | `type10_x` | Type 10 | Japan | X | Modern | Production |
| 212 | PROD | `type90_x` | Type 90 | Japan | IX | Modern | Production |
| 213 | PROD | `amx40_x` | AMX-40 | France | IX | Cold War | Production |
| 214 | PROD | `ariete_c1_x` | C1 Ariete | Italy | IX | Modern | Production |
