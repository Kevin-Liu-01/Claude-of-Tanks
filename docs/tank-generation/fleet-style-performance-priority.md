...
| FSP-05 | Complete lower hull/chassis side plates and connect hull sides, shoulders, fenders and skirts without accidental holes or floating panels. | LANDED 2026-09-25 (owner: yes) — 16 hulls closed ([audit](chassis-closure-audit-20260925.md): 23 → 7 unsealed ids, the 7 turret-owned; fleet openings 6,299 → 1,912 px); floating-panel candidates recorded there for the next round |
