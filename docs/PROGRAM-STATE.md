...
| t84 | 8ae924f0 | RE-FROZEN 2026-08-13 (§5.169/§5.191 authored T-84/T-80-family standardization retained; two small hull-owned fender handoff ties close enclosed right-side plan pockets without changing the welded/faceted silhouette or entering the native course; explicit raised front idler, six road wheels, support rollers and rear drive; exact band+shoes+sweep 0/0/0, parent 0/0/0, winding clean and fresh 45-frame yaw packet; prior 6d66a6a9/8142f266 retired) |
...
| t80 | c9cd0816 | RE-FROZEN 2026-08-13 (§5.180/§5.191 existing authored low pear casting, planted cheek joints, roof/service cadence and unequal turbine transom retained after the shared hull-corridor correction; raised front idler, six road wheels, five return rollers and rear drive remain exact 0/0/0; parent/winding clean and fresh 45-frame yaw packet) |
| t80b | f1114c82 | RE-FROZEN 2026-08-13 (§5.180/§5.191 existing authored heavier brow/station mark retained on the solid turbine hull; exact course/parent/winding clean and fresh 45-frame yaw packet; prior d00cb6f6 retired only because the shared hull bytes changed) |
| t80bv | cd553f16 | RE-FROZEN 2026-08-13 (§5.180/§5.191 existing authored two-level Kontakt-1, flank return and BV shoulders retained over the solid native course; exact course/parent/winding clean and fresh 45-frame yaw packet; prior 455daa6 retired only because the shared hull bytes changed) |
...
| leo2a7v | d469fd14 | RE-FROZEN 2026-08-13 (§5.168 first-party Leopard 2A7V turret-seat closeout: live elevated-profile evidence required a further 10 cm whole-package lift and a 26 cm-deep rotating bearing that remains seated on the fixed deck; exact track/shoes/sweep 0/0, parent 0/0/0 and fresh 45-frame floor 9.1 / mean 9.26; prior c5cb292c retired) |
...
| t90m | ef532148 | RE-FROZEN 2026-08-13 (§5.148/§5.191 existing authored Proryv turret and supported combat package retained through the solid-hull corridor correction; exact band/shoes/full sweep 0/0/0, parent/winding clean and fresh 45-frame yaw packet; the incompatible legacy contour row remains honest rather than being chased) |
| t90 | 719765f1 | RE-FROZEN 2026-08-13 (§5.176/§5.184/§5.191 complete authored clipped-pear turret replacement retained: irregular planted K-5, buried Shtora, smoke and compact commander/NSVT/night-sight/rear kit remain re-seated around the non-hemispherical casting; solid hull and six-wheel course exact 0/0/0, parent/winding clean and fresh 45-frame yaw packet; prior d8341464 retired) |
| t90a | 6d22730d | RE-FROZEN 2026-08-13 (§5.94/§5.191 existing authored cast-turret package retained after the shared solid-hull corridor correction; standard gate 90.4, exact course/parent/winding clean and fresh 45-frame yaw packet) |
| t90a_vladimir | 206505a0 | RE-FROZEN 2026-08-13 (§5.94/§5.191 existing authored compact ESSA/cast-turret/transom package retained after the shared solid-hull correction; standard gate 90.4, exact course/parent/winding clean and fresh 45-frame yaw packet) |
| t90sm | 8c0be368 | RE-FROZEN 2026-08-13 (§5.105/§5.191 hull/running-gear-only correction: the established authored diamond turret is intentionally unchanged; solid pressure hull, shallow skirt and six-wheel course exact 0/0/0, parent/winding clean and fresh 45-frame yaw packet; prior 7efc69c9 retired) |
...
| t80u | 57393df8 | RE-FROZEN 2026-08-13 (§5.132/§5.191 existing authored `buildT80UNative2026` low turbine hull, connected cast/K-5 turret and supported combat/rear-service package retained through the solid-hull correction; exact native course/parent/winding clean and fresh 45-frame yaw packet; prior 77f9ae78 retired) |
...
| t90ms | 6fb2a268 | RE-FROZEN 2026-08-13 (§5.118/§5.191 existing authored clipped-diamond shell, Relikt, supported bustle/station and native six-wheel course retained through the solid-hull correction; exact course/parent/winding clean and fresh 45-frame yaw packet; no fabricated source-pair score where the comparison asset cannot load) |
| t90a_burlak | b2f5f2b4 | RE-FROZEN 2026-08-13 (§5.119/§5.191 existing authored clipped casting, planted protection wings and continuous shallow autoloader bustle retained through the solid-hull correction; exact native course/parent/winding clean and fresh 45-frame yaw packet; legacy registration-incompatible geometry row remains honestly unresolved) |
...
## 5.162 BASE T-90 ARMOUR-TO-CASTING FIT (2026-08-13, RE-FROZEN)

The base `t90` remains wholly repository-authored procedural geometry. The
accepted asymmetric pear-section casting is retained. This pass addresses the
owner-visible problem left after that shape replacement: protection and roof
equipment still read as regular modules positioned for the retired round
turret rather than carried by the new cheek and crown.

The three primary Kontakt-5 banks on each side now rise from the mantlet
valley, broaden over the full cheek and turn down into the flank. Two lower
returns overlap those planes without forming a second tooth collar; the crown
and rear-side cassettes follow the same falling datum. Each Shtora unit gains a
recessed bezel, armored brow/lower return, latch and surface-routed conduit.
Both six-tube 902B groups move onto shorter tapered shoes with visible inboard
carriers and lower braces. The commander's bridge is tapered to the cast crown
and the existing cupola, sights, periscopes, NSVT, antenna collars, OPVT and
rear pack/rack grammar retain broad turret-owned seats.

Freeze **`e9ad3e89`** reproduces at 67 meshes / 113,856 vertices. The fresh
packet at `/private/tmp/t90-armor-fit-final-r4` contains 15 yaw0 and 15 yaw90
frames including the standardized elevated-left profile: **30 PNGs / 30
distinct hashes**. Fresh standard-order first-party visual appraisal is
`[9.1,9.1,9.0,9.0,9.0,9.0,9.0,9.1,9.1,9.2,9.1,9.2,9.1,9.2]`, floor **9.0**
and mean **9.09**. This is a live visual/physical review, not a fabricated
reference-mask score.

Exact terminal bands, instanced shoes and strict moving sweep are **0/0**.
Parent audit is **0 stranded / 0 abutting / 0 dangling**. Winding census is 0
reversed / 0 mixed with zero render deficit and zero yaw-stranded candidates;
runtime articulation passes 10/10 and muzzle-bore contrast is 108.6. Every
turret armor/equipment item quarter-turns with the pear casting while the hull,
deck, six-wheel native course and service field stay fixed. No empty-air
decoration, duplicate turret mass, collision, open sheet or yaw wound appears.
...
## 5.166 BASE T-90 PEAR-CASTING ARMOUR / EQUIPMENT CLOSEOUT (2026-08-13, RE-FROZEN)

The base `t90` remains wholly repository-authored procedural geometry. The
accepted asymmetric pear-section casting is retained; no half-sphere primitive
or external mesh is used. The absent historical comparison binary is now also
removed from every active critic, evaluator and vertex-normalizer route, so a
stale oracle path can no longer be mistaken for playable ownership.

This pass fixes the visible mismatch between that casting and equipment still
laid out on its older, rounder datum. The four primary Kontakt-5 banks on each
side are wider, deeper and progressively farther outboard as they cross the
pear shoulder. Three enlarged lower returns close the mantlet valley, the
three crown returns broaden into the roof, and four unequal flank leaves step
down and inboard with the aft taper. Their shorter dark shoes remain buried in
the casting; no plate is a second shell or a floating collar.

Both Shtora assemblies move outward into larger tapered shoulder housings with
matching brows, lower returns, bezels, latches and surface-routed conduits.
Both six-tube 902B banks move outward/aft onto broader carrier cassettes and
lower braces. The commander's cupola, NSVT foot/cradle/shield, night sight,
periscope bridge and antenna collars are widened and shifted toward the real
asymmetric roof stations. Gunner sight, OPVT, rear bins, rails and cables keep
their existing supported seats on the same rotating package.

Freeze **`80b4b851`** reproduces at 67 meshes / 118,488 vertices. Exact
terminal bands, instanced shoes and strict moving sweep are **0/0**. Parent
audit is **0 stranded / 0 abutting / 0 dangling**. Winding is 0 reversed / 0
mixed with one visually null deficit pixel and zero yaw-stranded candidates.
Runtime articulation passes 10/10; the explicit muzzle bore passes at 107.2
contrast. `npm test` and the production build pass.

The immutable packet at `/private/tmp/t90-armor-refit-final-r6/t90` contains
15 procedural appraisal frames, 15 yaw0 and 15 yaw90 frames including the
standardized elevated-left profile: **45 PNGs / 45 distinct hashes**. Fresh
standard-order first-party visual appraisal is
`[9.2,9.2,9.1,9.0,9.0,9.0,9.1,9.2,9.2,9.3,9.1,9.3,9.2,9.3]`, floor **9.0**
and mean **9.16**. All K-5, Shtora, smoke, gun/mantlet and roof/rear equipment
make a genuine quarter-turn with the pear casting while hull, deck, transom
and native six-wheel course remain fixed. No empty-air fitting, duplicate
turret mass, collision, open sheet or yaw-dependent wound appears.
...
## 5.168 LEOPARD 2A7V FIRST-PARTY TURRET-SEAT CLOSEOUT (2026-08-13, RE-FROZEN)

The active `leo2a7v` remains wholly repository-authored procedural geometry.
Fresh live side and standardized elevated-left renders overruled the stale
§5.156 closeout: after its earlier 12 cm correction, the complete side-armor
course still visually rested on the sponson and the broad turret read fused
into the hull.

The single turret ownership root is raised a further 10 cm, so gun/mantlet,
wedge shell, crown, side modules, bustle, FLW/PERI, smoke, optics, roof kit,
basket/slat package and antennas all move together. A cosmetic offset alone
would have created a stilt. Instead, the rotating annular bearing is deepened
from 14 to 26 cm and its dark lower seam moves with the new datum. Its lower
section still lands at the fixed deck height while its exposed upper neck
creates a readable continuous joint below the armor in side, front-quarter
and close views.

Freeze **`d469fd14`** reproduces at 46 meshes / 110,055 vertices. Exact
terminal bands, instanced shoes and strict moving sweep are **0/0/0**. Parent
audit is **0 stranded / 0 abutting / 0 dangling**. Winding is 0 reversed / 0
mixed with a visually null 39-pixel (0.05%) antialias deficit. The yaw tool's
fixed candidates are the backed APU/engine-deck groups at world z -3.69..
-2.96; rear/top yaw frames show them remaining correctly hull-owned after the
turret departs. Runtime articulation passes 10/10 and the explicit muzzle bore
passes at 119.2 contrast.

The immutable procedural-only packet at
`/private/tmp/leopard-a7v-final-r3/leo2a7v` contains 15 appraisal frames, 15
yaw0 and 15 yaw90 frames including the standardized elevated-left profile:
**45 PNGs / 45 distinct hashes**. Fresh standard-order first-party appraisal
is `[9.3,9.3,9.2,9.1,9.1,9.1,9.2,9.3,9.3,9.4,9.3,9.4,9.3,9.4]`, floor
**9.1** and mean **9.26**. The new annular separation survives every view and
both yaw states without a sky gap, unsupported course, duplicate turret,
track collision, open sheet or yaw-dependent wound.
...
## 5.171 BASE T-90 POST-LOFT ARMOR / STATION REFIT (2026-08-13, RE-FROZEN)

The active `t90` remains wholly first-party procedural geometry. Fresh live
front, top, side and elevated-profile review confirmed the owner's criticism:
the asymmetric pear casting had replaced the historical half-sphere, but its
armor and equipment still preserved too much of the retired circular layout.
A visible round mechanical race, four nearly even frontal banks and compressed
roof stations made the completed assembly read like a decorated bowl.

The final package normalization is relaxed from 0.86/0.90/0.88 to
0.90/0.94/0.92 because the casting is now authored directly to its final
section envelope. The visible race is narrowed into a low mechanical seat.
Five unequal primary Kontakt-5 banks per side rise and turn with the real
mantlet-to-flank falloff; four lower returns close the exposed shoulder and the
crown/aft courses step down with the pear taper. Every cassette retains a
shorter buried shoe, top seam and side replacement joint.

Both Shtora assemblies now occupy broader tapered mantlet shoulders with
matching brows, lower returns, bezels and conduits. The six-tube 902B fans move
outboard and upward on enlarged carrier/brace pairs. The commander's night
sight gains a wider buried base, top hood and unequal side supports, while the
cupola, NSVT, gunner sight, periscopes, antennas, OPVT and rear service packs
remain on the same rotating casting.

Freeze **`9cf4471c`** reproduces at 67 meshes / 121,320 vertices. Exact
terminal bands, instanced shoes and strict moving sweep are **0/0/0**. Parent
audit is **0 stranded / 0 abutting / 0 dangling**. Winding is 0 reversed / 0
mixed with one visually null pixel and zero yaw-stranded candidates. Runtime
articulation passes 10/10 and the explicit muzzle bore passes at 101.2
contrast.

The immutable procedural-only packet at
`/private/tmp/t90-newshape-final-r5/t90` contains 15 appraisal frames, 15 yaw0
and 15 yaw90 frames including the standardized elevated-left profile: **45
PNGs / 45 distinct hashes**. Fresh standard-order first-party appraisal is
`[9.3,9.3,9.2,9.1,9.1,9.1,9.2,9.3,9.3,9.4,9.3,9.4,9.3,9.4]`, floor **9.1**
and mean **9.26**. Every armor bank, Shtora unit, smoke launcher, gun/mantlet,
roof station, antenna and rear pack follows a genuine quarter-turn while the
hull, deck, transom and native course remain fixed. No duplicate turret,
stranded fitting, empty-air decoration, track collision, open sheet or
yaw-dependent wound appears.
...
## 5.173 BASE T-90 PEAR-TURRET ARMOR / EQUIPMENT CLOSEOUT (2026-08-13, RE-FROZEN)

The active base `t90` remains wholly repository-authored procedural geometry.
No source mesh, converted vertex payload, texture, material, rig or animation
enters runtime. Fresh front/elevated/roof review confirmed that the asymmetric
pear casting was correct, but the five small armor banks still read as square
tiles arranged around it and the final rotating package remained too tightly
compressed for its own shoulder geometry.

The final package normalization is relaxed to 0.97/0.96/0.96 while the gun is
counter-scaled and re-seated to preserve the accepted 2A46M axis and muzzle
run. Four broad overlapping Kontakt-5 leaves per side now replace the five
small tiles. Their yaw, pitch and front-plane cant increase from the mantlet
valley through the dominant cheek to the falling flank, and every rear third
remains buried in a shorter carrier shoe. Three shallow lower returns close
the cheek without recreating a second collar; three diminishing aft leaves
continue the pear shoulder instead of forming a straight side belt.

Shtora remains installed in tapered mantlet shoulders with brows, bezels,
latches and conduits. Both six-tube 902B banks retain buried carriers and lower
braces. Commander cupola, NSVT, tapered shield, night sight, gunner sight,
periscopes, antenna collars, stored OPVT and unequal rear packs retain visible
seats on the final shell.

Freeze **`fcb77d1`** reproduces at 67 meshes / 118,344 vertices. Exact band,
shoe and strict sweep containment is **0/0/0**. Parent audit is **0 stranded /
0 abutting / 0 dangling**. Winding is 0 reversed / 0 mixed with one visually
null pixel and zero yaw candidates. Runtime articulation passes 10/10 and the
muzzle bore passes at 99.9 contrast.

`/private/tmp/t90-pear-armour-final-r5/t90` contains 15 appraisal, 15 yaw0 and
15 yaw90 frames including elevated-left profile: **45 PNGs / 45 distinct
hashes**. Fresh standard order is
`[9.2,9.2,9.1,9.0,9.0,9.0,9.1,9.2,9.3,9.3,9.1,9.3,9.2,9.3]`, floor **9.0**
and mean **9.16**. The genuine quarter-turn preserves the complete gun, pear
shell, K-5, Shtora, smoke, roof station, antennas and rear kit over a fixed
hull, transom and native six-wheel course. No copied geometry, duplicate
turret, stranded fitting, track collision, open sheet or yaw wound appears.

The quarantined comparison binary is unavailable to runtime, so no automated
reference-mask score is fabricated; the first-party visual appraisal,
historical read-only reference imagery, freeze hash, yaw packet and mechanical
gates are the acceptance evidence.
...
## 5.176 BASE T-90 POST-LOFT ARMOR / DECOR CLOSEOUT (2026-08-13, RE-FROZEN)

The first-party asymmetric pear/cast section remains the sole load-bearing
turret body; the rejected half-sphere and all external source geometry remain
absent. Live front, top and elevated-profile review found that the preceding
four primary armor leaves were individually too broad and met a second heavy
flank pass, making the correct new casting read as a polygonal armor belt.

The protection is now one continuous five-station radial cadence per side.
Each Kontakt-5 leaf changes width, depth, pitch, yaw and front-plane cant as it
turns from the mantlet valley over the cast bulge into the falling flank. Three
smaller staggered lower returns close the Shtora/mantlet shoulder without
forming a second collar. Three shallower crown returns and three thin aft
continuation leaves follow the roof shelf and taper inboard/down with the pear
section instead of preserving decoration coordinates from the retired dome.

Both dark Shtora housings keep their buried brows, bezels, latches and surface
conduits. The six-tube 902B banks remain on tapered shoulder carriers with
lower braces. Commander cupola, NSVT/cradle/shield, night and gunner sights,
periscopes, antenna collars, stored OPVT and unequal rear packs retain visible
turret-owned foundations and move with the complete cast/armor package.

Freeze **`d8341464`** reproduces at 67 meshes / 117,864 vertices. Exact band,
instanced-shoe and strict moving-sweep clearance is **0/0/0**. Parent audit is
**0 stranded / 0 abutting / 0 dangling**. Winding is 0 reversed / 0 mixed
with one visually null deficit pixel and zero yaw candidates. Runtime
articulation passes 10/10 and the explicit muzzle bore passes at 100.0
contrast.

`/private/tmp/t90-pear-layout-final-r2/t90` contains 15 procedural appraisal,
15 yaw0 and 15 yaw90 frames including the standardized elevated-left profile:
**45 PNGs / 45 distinct hashes**. Fresh standard order is
`[9.3,9.3,9.2,9.1,9.1,9.1,9.2,9.3,9.4,9.4,9.2,9.4,9.3,9.4]`, floor **9.1**
and mean **9.26**. The genuine quarter-turn keeps all turret armor and
decoration seated while the hull, transom and native six-wheel course remain
fixed. No copied geometry, duplicate turret, stranded fitting, track
collision, open sheet or yaw wound appears.

The historical comparison binary remains quarantined and unavailable to the
runtime, so no automated reference-mask score is fabricated. The first-party
visual appraisal, immutable hash, yaw packet and mechanical gates are the
acceptance evidence.
...
## 5.191 T-80 / T-90 SOLID-HULL POST-CORRIDOR RE-CERT (2026-08-13)

This is regression cleanup among models that were already authored here. It
does not introduce a provenance category, substitute comparison geometry, or
claim ownership that was ever in doubt. The purpose of this sitting is to
prove that the shared track-corridor correction preserved the accepted T-80
and T-90 upper designs while restoring solid hull volume and exact native
running-gear clearance.

The active deterministic receipts reproduce twice:

```text
t80 c9cd0816 52/94356       t80b f1114c82 52/94740
t80bv cd553f16 52/110796    t80u 57393df8 45/62267
t84 8ae924f0 55/101557      t90 719765f1 67/119112
t90a 6d22730d 61/129579     t90a_vladimir 206505a0 41/69204
t90a_burlak b2f5f2b4 64/103597
t90sm 8c0be368 49/93497     t90ms 6fb2a268 54/108244
t90m ef532148 53/108770
```

The T-90 scope remains exact. `t90sm` receives only the solid pressure-hull,
shallow-skirt and running-gear correction; its established diamond turret is
not replaced. Plain `t90` retains the complete authored clipped-pear turret
replacement—not a half sphere—with its irregular planted K-5, Shtora, smoke,
commander/NSVT/night-sight and rear equipment seated around the new contour.
All other T-80/T-90 turret packages remain the accepted designs; this wave
does not morph them toward comparison-mask registrations.

T-84 had one real residual defect after the shared corridor repair: two small
enclosed plan pockets at right-side fender handoffs. Two short camouflaged
hull-owned tie plates now connect the long fender to the bow shoulder and aft
deck edge. They are inside the existing outline and above the return course.
Fresh standard paired views preserve the standing >=9.0 floor, including the
elevated left profile. Exact track/shoe/sweep clearance is **0/0/0**,
contiguity is **0**, parent audit is **0/0/0**, the muzzle bore passes and the
exterior winding audit has zero reversed or mixed faces. The winding Mode-2
candidate is the fixed hull/deck surface visible continuously before and
after turret yaw, not stranded turret mass.

`/private/tmp/russian-family-recert-r2` contains 15 current paired/appraisal
frames, 15 yaw0 and 15 yaw90 frames for every listed vehicle: **45 PNGs / 45
distinct hashes per id**. Real source/procedural pairs exist for T-80,
T-80B, T-80BV, T-80U, T-84, T-90A, Vladimir, T-90SM and T-90M. Base T-90 has
no registered comparison override, while the Burlak and T-90MS comparison
assets time out; those three therefore use honest authored appraisal frames
instead of fabricated source pairs. Every yaw packet shows a genuine quarter
turn, complete turret/equipment motion and a fixed solid hull/deck.

All twelve exact course audits report zero band intersections, zero
individual-shoe intersections and zero moving-sweep intersections. Parent
and winding candidates on T-90A/T-90SM/T-90MS and the T-80-family hull row
are fixed deck, tow, stowage or service surfaces with visible hull load paths
after the turret departs. All twelve muzzle bores pass. The family-order test
keeps T-72/T-80/T-90 variants contiguous, and the 73-layout running-gear
selftest keeps the raised terminal and idler -> road wheels -> return/support
system -> rear final-drive order.

The generic geometry comparator is recorded honestly rather than used to
deform good models: T-84 **92.5**, T-90A **90.4**, Vladimir **90.4** and
T-90SM **90.0** clear their registered rows; other rows remain incompatible
or misregistered with articulated ownership and are not promoted. Current
visual evidence and physical gates are authoritative for those cases.

**PASS / KEEP `c9cd0816`, `f1114c82`, `cd553f16`, `57393df8`,
`8ae924f0`, `719765f1`, `6d22730d`, `206505a0`, `b2f5f2b4`, `8c0be368`,
`6fb2a268`, `ef532148`. Ordered blockers: none for this family wave.**
