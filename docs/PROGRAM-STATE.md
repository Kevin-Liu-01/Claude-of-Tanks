...
| strv103 | 4ac3c8c8 | RE-FROZEN 2026-08-17 (§5.271 graduate-change re-cert: §5.248 ground-up wholesale rebuild — measured loft onto the published frame vs the length-short print, critic 9.2 with §B5 fixed-mount proven diffPx:0; prior 4d0ff518 retired) |
...
## §5.299 — Strv 81 garage-scale turret articulation (OWNER session entry) (2026-08-17)
