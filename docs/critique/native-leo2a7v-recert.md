...
The prior compatible photo-class packet recorded **90.23** overall with a
**90.02** minimum standard view. The current comparison export retains the
fused/proportionally incompatible component/P95 behavior documented below,
...
Winding is 0 reversed / 0 mixed. The 39-pixel (0.05%) front-left difference
