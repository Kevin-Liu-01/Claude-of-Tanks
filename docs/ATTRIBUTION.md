...
samples anywhere. The ONE on-disk audio category is the battle announcer voice
set, and it is generated, not sourced:
...
official `piper-tts` PyPI wheels instead.
