#!/usr/bin/env python3
# leo2a5 r6 critic — ITU-601 luma rects + censuses on the fresh official pairs.
# Same windows as the r5 adjudication (tmp-critic-a5r5-measure.py) so the
# r6 done-gates re-derive 1:1. HALF-frame coords (each half 640x640).
import numpy as np
...
print('== view-left: gear band / turret field / hull field / disc ==')
...
print('== view-rear: louvre band / taillights / flap-track corners ==')
...
rowvar('REF  trackrearL-ladder', ref, 68, 160, 480, 555)
rowvar('PROC trackrearL-ladder', proc, 68, 160, 480, 555)
