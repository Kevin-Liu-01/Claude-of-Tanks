...
// hmr:false — the critique loop edits src/ concurrently; a vite HMR full
// reload mid-evaluate destroys the puppeteer execution context.
...
try {
  ...
  await battleE2E('kf51', 'KF51 Panther (wave-4 newcomer)');
  await battleE2E('merkava4', 'Merkava Mk4 (wave-4 model replacement)');
