...
assert.match(source, /stats\.forwardCorrectionRad - Math\.PI/);
...
assert.match(source, /expectedExhibits = isVerdant \? 4 : 6/);
assert.match(source, /fixed Verdant set leaked into an additive garage/);
